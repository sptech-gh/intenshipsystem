      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" method="post">
            ...
            Deadline       <input type="date" id="datepicker00" name="deadline" class="form-control">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            Start Date       <input type="date" name="start_date" id="datepicker3000" class="form-control">
            End Date       <input type="date" name="end_date" id="datepicker2000" class="form-control">
...
<footer class="pull-left footer">
  			<p class="col-md-12">
  				<hr class="divider">
  				Copyright &COPY; <?php echo date('Y'); ?> <a href="#">Datalink Online Internship System</a>
  			</p>
  		</footer>
  	</div>
