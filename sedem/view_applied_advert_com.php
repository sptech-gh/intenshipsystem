...
//                echo 'bad <br>';
//            }
            $result2 = $database->query_db("UPDATE apply_company_advert SET commence_date = '$commence_date', int_status='on-going' WHERE id='".$_GET['id']."' && student_id='".$_GET['student_id']."'");
            
            $result1 = $database->query_db("UPDATE users SET intern_status = '$intern_status' WHERE username='".$_GET['student_id']."'");
...
<div class="container">
    <div class="row">
                ...
                <form action="" method="post">
                    <table class="table table-stripped">
                        ...
                        <tr>
                            <td>Date Applied</td>
                            <td>
                                <?php echo date("D d M, Y",strtotime($frow['ac_doe'])); ?>
                            </td>
                        </tr>
                        <tr>
                            <td>Date of Commencement</td>
                            <td><input type="date" id="datepicker5000" class="form-control" name="com_date" placeholder="eg: 2007-12-25"></td>
                        </tr>
                        <tr>
                            <td></td>
        ...
        <div class="col-md-4">
            ...
            <?php if($frow['c_docx']==TRUE){ ?>
            <a href="uploads/company/docx/<?php echo $frow['c_docx']; ?>" class="btn btn-primary" download="<?php echo $frow['c_docx']; ?>"><span class="fa fa-download"></span> Document (.docx)</a>
            <?php }else{echo "";} ?>

            <?php if($frow['c_pdf']==TRUE){ ?>
            <a href="uploads/company/pdf/<?php echo $frow['c_pdf']; ?>" class="btn btn-primary" download="<?php echo $frow['c_pdf']; ?>"><span class="fa fa-download"></span> PDF (.pdf)</a>
            <?php }else{echo "";} ?>
        </div>
    </div>
