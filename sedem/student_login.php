...
if(isset($_POST['login'])){
    ...
    $result = $database->query_db("SELECT * FROM users WHERE username='".$username."' AND pin='".$pin."' AND intern_status='0' ");
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4" style="background-color:rgba(94, 0, 0, 0.54);">
                    ...
                    <form action="" method="post">
                        <p class="text-center"><img class="avatar" width="120px" src="assets/images/dli-logo.png"></p>
                    ...
                    <p class=""><a href="student"><small>CLICK HERE TO REGISTER STUDENT</small></a></p><br><br>
